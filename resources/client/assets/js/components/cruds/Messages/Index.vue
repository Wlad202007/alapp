...
import DatatableAttachmentsField from './dtmodules/DatatableAttachmentsField'
    ...
    data() {
        return {
            columns: [
                ...
                { title: 'Attachments', tdComp: DatatableAttachmentsField, sortable: false },
                { title: 'Users', field: 'users', tdComp: DatatableList },
                { title: 'Author', field: 'author', tdComp: DatatableSingle },
                { title: 'Group', field: 'group', tdComp: DatatableSingle },
                { title: 'Read', field: 'read', tdComp: DatatableCheckbox, colStyle: 'width: 50px;' },
