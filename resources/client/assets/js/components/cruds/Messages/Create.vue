...
export default {
    ...
    methods: {
        ...mapActions('MessagesSingle', ['storeData', 'resetState', 'setBody', 'setAttachments', 'destroyAttachments', 'destroyUploadedAttachments', 'setUsers', 'setAuthor', 'setGroup', 'setRead', 'fetchUsersAll', 'fetchUsersAll', 'fetchEventsAll']),
        updateBody(e) {
