...
<script>
    ...
    created() {
        this.fetchEventsAll(this.$route.params.event)
		console.log('create',this.$route.params.event)
    },
    destroyed() {
        this.resetState()
    },
	watch: {
		 ...
		 "$route.params.event": function() {
            this.resetState()
             this.fetchEventsAll(this.$route.params.event)
			console.log('watch',this.$route.params.event)
        }
    },
    methods: {
    ...mapActions('AgendasSingleevent', ['storeData', 'resetState', 'setEvent', 'setTime', 'setText', 'setDate', 'setLabel', 'fetchEventsAll']),
            updateEvent(value) {
            this.setEvent(value)
        },
        updateTime(e) {
