...
export default {
    ...
    methods: {
        ...mapActions('UsersSingle', ['storeData', 'resetState', 'setAvatar', 'setName', 'setDescription', 'setCompany', 'setJob', 'setPhone', 'setEmail', 'setPassword', 'setRole', 'setMy_events', 'fetchRolesAll', 'fetchEventsAll']),
        removeAvatar(e, id) {
            this.$swal({
                title: 'Are you sure?',
