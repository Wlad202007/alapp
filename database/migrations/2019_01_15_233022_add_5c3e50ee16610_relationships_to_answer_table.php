...
class Add5c3e50ee16610RelationshipsToAnswerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('answers', function(Blueprint $table) {
            if (!Schema::hasColumn('answers', 'session_id')) {
                ...
                $table->foreign('question_id', '25668_5c3e50ed9f8cc')->references('id')->on('answers')->onDelete('cascade');
                }
